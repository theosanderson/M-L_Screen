...
loadAndCollapse<- function(file){
  counts<-read.csv(here(file), header=T,stringsAsFactors=FALSE)
...
metadata %>% filter(Pool=="L", Mouse==3, Condition=="Rec")
files<-unique(paste0(metadata$Run,".csv"))
#files<-c("PbSTM93.csv","PbSTM94.csv","PbSTM95.csv","PbSTM96.csv","PbSTM102b.csv","PbSTM103.csv","counts_21532.csv","21132.csv","21162.csv","20536.csv","20569.csv","22878.csv","counts_23317.csv","counts_23330.csv","counts_23245.csv")
